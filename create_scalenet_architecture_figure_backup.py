...
def create_scalenet_architecture():
    ...
    ax.text(7, y_start - 0.2, r'$\boldsymbol{\theta}_{\text{scale}} = [\theta_1, \theta_2, \theta_3]$',
            fontsize=11, ha='center', fontweight='bold')
    ax.text(7, y_start - 0.6, r'Initialized: $[0.05m, 0.10m, 0.20m]$',
            fontsize=9, ha='center')
    ax.text(7, y_start - 0.95, r'Learned via $\nabla_{\theta} \mathcal{L}_{\text{det}}$',
    ...
    ax.text(14, y_start - 0.6, r'Output: Logits $\mathbf{z}_i \in \mathbb{R}^3$',
            fontsize=10, ha='center')
    ax.text(14, y_start - 1.0, r'Gumbel-Softmax: $\sigma_i = \text{softmax}(\frac{\mathbf{z}_i + \mathbf{g}}{\tau})$',
            fontsize=9, ha='center', style='italic')
    ...
    for i, x_pos in enumerate(x_positions):
        ...
        ax.text(x_pos, y_lower + 0.25, r'Output: $\mathbf{f}_i^{(s)} \in \mathbb{R}^{C}$', 
                fontsize=9, ha='center', style='italic')
    ...
    # Aggregation formula
    ax.text(12, y_agg + 1.0, r'$\mathbf{f}_i = \sum_{s=1}^{3} \sigma_i^{(s)} \cdot \mathbf{f}_i^{(s)}$',
    ...
    ax.text(12, y_head + 0.75, r'Classification + Regression (BBox, Heading, Size)',
            fontsize=10, ha='center')
    ax.text(12, y_head + 0.35, r'Loss: $\mathcal{L}_{\text{det}} = \mathcal{L}_{\text{cls}} + \mathcal{L}_{\text{reg}}$',
    ...
    grad_labels = [
        (20.5, 2.5, r'$\frac{\partial \mathcal{L}}{\partial \mathbf{f}_i}$'),
        (20.5, 4.5, r'$\frac{\partial \mathcal{L}}{\partial \mathbf{f}_i^{(s)}}$'),
        (20.5, 7, r'$\frac{\partial \mathcal{L}}{\partial \sigma_i}$'),
        (20.5, 10, r'$\frac{\partial \mathcal{L}}{\partial \mathbf{z}_i}$'),
        (20.5, 12, r'$\frac{\partial \mathcal{L}}{\partial \theta_{\text{scale}}}$'),
    ]

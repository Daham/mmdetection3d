...
def create_technical_scalenet_diagram():
    ...
    ax.text(4, y_top - 0.8, r'Point Cloud: $\mathbf{P} = \{p_i\}_{i=1}^{N}$', fontsize=11, ha='center', fontweight='bold')
    ...
    ax.text(11.5, y_top - 0.7, r'$\mathbf{\theta_{scale}} = [\theta_1, \theta_2, \theta_3]$', 
    ...
    ax.text(layer2_x, y_mlp - 0.65, r'$\mathbf{h}_1 = \text{ReLU}(W_1 p_i + b_1)$', fontsize=9, ha='center')
    ...
    ax.text(layer3_x, y_mlp - 0.65, r'$\mathbf{h}_2 = \text{ReLU}(W_2 \mathbf{h}_1 + b_2)$', fontsize=9, ha='center')
    ...
    ax.text(layer4_x, y_mlp - 0.65, r'$\mathbf{z}_i = W_3 \mathbf{h}_2 + b_3$', fontsize=9, ha='center')
    ...
    ax.text(layer4_x, y_mlp - 2.6, r'$\mathbf{z}_i = [z_i^{(1)}, z_i^{(2)}, z_i^{(3)}]$', fontsize=8, ha='center')
    ...
    ax.text(step1_x, y_gumbel - 0.2, r'Sample: $g_i^{(s)} \sim \text{Gumbel}(0,1)$', fontsize=9, ha='center')
    ax.text(step1_x, y_gumbel - 0.7, r'$g = -\log(-\log(u))$', fontsize=9, ha='center')
    ax.text(step1_x, y_gumbel - 1.15, r'where $u \sim \text{Uniform}(0,1)$', fontsize=8, ha='center')

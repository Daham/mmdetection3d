# DEBUGGING CONFIG - Nearly Identical to Vanilla SECOND
# Use this to verify the adaptive module doesn't interfere when disabled
...
model = dict(
    ...
    voxel_encoder=dict(
        ...
        num_features=4,
        learnable_adaptation=False,        # Disabled
        adaptation_strength=0.0,          # No adaptation = vanilla SECOND
        use_attention=False,               # Disabled
        multi_scale=False,                 # Disabled
        warmup_epochs=999999),             # Never enable adaptation

#!/bin/bash
# ==============================================================================
# CYCLIST CLASS COMPARISON: 2 Methods, 5 Epochs Each
# ==============================================================================
# Compares:
...
# ==============================================================================
# METHOD 2: Adaptive Multi-Scale Cyclist
# ==============================================================================
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
extract_result() {
    ...
    result=$(grep "Cyclist_3D_AP11_moderate_strict" "$log_file" 2>/dev/null | \
             tail -1 | \
...
if [ "$result_2" != "N/A" ] && [ "$result_1" != "N/A" ]; then
    ...
    if (( $(echo "$diff_2 > 1.0" | bc -l) )); then
        ...
        echo "   → Cyclist class benefits from adaptive voxelization"
